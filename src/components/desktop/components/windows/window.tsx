  ...
  return (
    ...
    >
      <Rnd
        ...
        className={cn(
          'flex transition-size transition-colors relative z-20 min-h-[400px] min-w-[50%] overflow-hidden rounded-md border border-love bg-highlightLow shadow-xl',
      ...
      >
        ...
        <header
          className={cn(
            'handle flex w-full transition-colors cursor-move touch-none justify-between gap-1 px-2 py-1 text-text',
            header.className
          )}
        >
          <p>{props.name}</p>
